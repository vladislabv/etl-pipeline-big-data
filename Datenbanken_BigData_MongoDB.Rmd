...
-   Beim Neustarten der Python-Anwendung werden alle zuvor gesammelten Daten in der Datenbank gelöscht.
...
3.  Bei der Pagination wird eine Annahme getroffen, dass es iteriert wird, bis man das Maximum erreicht (\< 10).
